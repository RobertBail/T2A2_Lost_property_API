...
# create a list of StaffProfile instances
    staffprofiles = [
        StaffProfile(
            staffprofile_id=1,
            staff_name="Admin",
...
# create a list of Item instances
 ...
 #claimedbys information to know who collected the item and when, eg. in case of mix-ups, theft even perhaps
 # create a list of ClaimedBy instances 
    claimedbys = [
        ClaimedBy(  
            name="Tim Johnson",
            phone="0200010110",
